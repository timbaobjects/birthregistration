...
class CenterUpdateView(
    ...
    template_name = 'backend/centre_edit.html'

    def get_context_data(self, **kwargs):
        instance = self.get_object()
        context = super(CenterUpdateView, self).get_context_data(**kwargs)

        context['page_title'] = 'Edit center: {}'.format(instance.name)
        context[u'location'] = instance
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            instance.active = form.cleaned_data.get('active')
            instance.save()
...
class CenterCreationView(
    ...
    page_title = u'Create registration centres'
    permission_required = 'locations.add_location'
    template_name = u'backend/centre_new.html'
