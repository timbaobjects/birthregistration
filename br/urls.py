...
urlpatterns = [
    ...
    url(r'^$', views.map_dashboard, name='map_dashboard'),

    url(r'^old/?$', views.dashboard, name='dashboard'),
    url(r'^old/(?P<year>\d+)/?$', views.dashboard, name='dashboard_with_year'),
    url(r'^old/(?P<year>\d+)/(?P<month>\d+)/?$', views.dashboard,
        name='dashboard_with_year_and_month'),
    url(r'^old/(?P<state>[a-z\-]+)/?$', views.dashboard,
        name='dashboard_with_state'),
    url(r'^old/(?P<state>[a-z\-]+)/(?P<year>\d+)/?$', views.dashboard,
        name='dashboard_with_state_and_year'),
    url(r'^old/(?P<state>[a-z\-]+)/(?P<year>\d+)/(?P<month>\d+)/?$', views.dashboard,
