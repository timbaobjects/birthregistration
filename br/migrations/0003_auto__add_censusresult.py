...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CensusResult'
        db.create_table(u'br_censusresult', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('location', self.gf('django.db.models.fields.related.ForeignKey')(related_name='census_results', to=orm['locations.Location'])),
            ('year', self.gf('django.db.models.fields.IntegerField')()),
            ('population', self.gf('django.db.models.fields.IntegerField')()),
            ('growth_rate', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal(u'br', ['CensusResult'])


    def backwards(self, orm):
        # Deleting model 'CensusResult'
        db.delete_table(u'br_censusresult')
